...
describe("ScoreboardsGrid", () => {
  it("renders correctly all available scoreboards", async () => {
    ...
    expect(
      await screen.findByText(/Games are about to start in 3 seconds./i)
    ).toBeVisible();
    expect(
      await screen.findByText(/Games are about to start in 2 seconds./i)
    ).toBeVisible();
    expect(
      await screen.findByText(/Games are about to start in 1 seconds./i)
    ).toBeVisible();
